...
def get_pg_url_from_heroku(email, pwd, prject_name, path_to_geckodriver, project_index):
    ...
    pbar = tqdm(total=100)
    pbar.postfix = "Apertura login page"
